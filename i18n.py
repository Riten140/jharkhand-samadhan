...
"en": {
    ...
    "my_reports_sub": "Problems you have reported — tap any card to track its progress.",
    "anonymous_reporter": "Anonymous Reporter",
    "anon_reporter_hint": "Reporter identity is hidden to protect them from retaliation.",
...
"hi": {
    ...
    "my_reports_sub": "आपके द्वारा दर्ज समस्याएँ — प्रगति देखने के लिए किसी कार्ड पर टैप करें।",
    "anonymous_reporter": "अज्ञात शिकायतकर्ता",
    "anon_reporter_hint": "प्रतिशोध से बचाने के लिए शिकायतकर्ता की पहचान छिपाई गई है।",
    "gallery_title": "ठीक व सत्यापित",
    "gallery_sub": "हल हो चुकी समस्याएँ जिनके बारे में कोई भी पढ़ सकता है — शिकायतकर्ता की पहचान हमेशा छिपी रहती है।",
    "gallery_before": "पहले",
